    ...
    <main className="flex flex-col items-center justify-center min-h-screen">
      ...
      <span className="mt-[38px] text-left w-[680px] text-[18px] font-medium">비밀번호</span>
        <Input
          ...
          className="mt-[15px] py-[16px] px-[18px] w-[680px] h-[56px]"
        />
      <p className="mt-[11px] text-right w-[680] text-[15px] font-[400] text-[#02C551] cursor-pointer" onClick={() => router.push("/forgot-password")}>비밀번호 찾기</p>
        <Button
          content="확인"
      ...
      <div className="mt-[14px] w-[680px] text-[14px] flex">
        ...
        <p className="text-[#02C551] ml-[9px] cursor-pointer" onClick={() => router.push("/signup")}>회원가입</p>
      </div>
    </main>
  );
}
...
export const AuthLayout = ({ title, description, children }: AuthLayoutProps) => (
  <main className="grid min-h-screen bg-[#F4F6F5] lg:grid-cols-[42%_58%]">
    <section className="relative hidden overflow-hidden bg-[#02C551] px-12 py-14 text-white lg:flex lg:flex-col lg:justify-between xl:px-16 xl:py-16">
      <div>
        <Image
          src="/JobdamIcon.svg"
          alt="잡담"
        ...
        <div className="mt-24 max-w-[440px]">
          ...
          <p className="mt-6 max-w-[390px] text-[15px] leading-7 text-green-50">
    ...
    <section className="flex min-h-screen items-center justify-center bg-[#F4F6F5] px-5 py-10 sm:px-8 lg:px-12">
      <div className="w-full max-w-[520px] rounded-[24px] bg-white px-6 py-8 shadow-[0_18px_50px_rgba(2,197,81,0.08)] sm:px-10 sm:py-10">

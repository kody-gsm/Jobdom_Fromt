...
export const Input = ({
  ...
  return (
    ...
    >
      <input
        type={inputType}
        className={`absolute inset-0 h-full w-full appearance-none rounded-lg bg-transparent pl-4 text-[20px] font-normal not-italic leading-[100%] tracking-normal text-black placeholder:text-[#95979D] placeholder:opacity-100 focus:outline-none ${

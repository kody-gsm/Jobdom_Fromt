...
const schedule = readFileSync("src/fsd/features/submit-consultation/model/schedulePresentation.ts", "utf8");
...
assert.match(schedule, /1교시", time: "08:40 - 09:30"/);
assert.match(schedule, /2교시", time: "09:40 - 10:30"/);
assert.match(schedule, /4교시", time: "11:40 - 12:30"/);
assert.match(schedule, /점심시간", time: "12:30 - 13:30"/);
assert.match(schedule, /5교시", time: "13:30 - 14:20"/);
assert.match(schedule, /7교시", time: "15:30 - 16:20"/);

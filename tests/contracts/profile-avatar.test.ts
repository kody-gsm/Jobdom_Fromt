...
assert.equal(MAX_PROFILE_AVATAR_BYTES, 5 * 1024 * 1024);
...
assert.equal(validateProfileAvatarFile({ type: "image/jpeg", size: MAX_PROFILE_AVATAR_BYTES + 1 }), "프로필 이미지는 5MB 이하만 사용할 수 있습니다.");

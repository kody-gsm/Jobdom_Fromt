...
const overview = buildHomeOverview({
  course: [
    { id: 2, name: "A", teacherId: 11, teacherName: "임경원 선생님", date: "2026-09-08", period: "3교시", status: "RESERVED" },
    { id: 1, name: "B", teacherId: 12, teacherName: "김권예소 선생님", date: "2026-09-06", period: "2교시", status: "WAITING" },
    { id: 4, name: "D", teacherId: 13, teacherName: "정윤기 선생님", date: "2026-09-09", period: "4교시", status: "CANCELED" },
  ],
  common: [{ id: 3, name: "C", teacherId: 14, teacherName: "강우빈 선생님", date: "2026-09-07", period: "1교시", status: "RESERVED" }],
  recruits: [
...
assert.equal(overview.upcomingConsultations.length, 3, "canceled consultations stay out of active collections");
assert.deepEqual(overview.upcomingConsultations.map((item) => item.date), ["2026-09-06", "2026-09-07", "2026-09-08"]);
assert.deepEqual(overview.upcomingConsultations.map((item) => item.teacherName), ["김권예소 선생님", "강우빈 선생님", "임경원 선생님"]);

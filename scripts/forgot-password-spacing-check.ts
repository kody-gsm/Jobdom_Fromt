...
assert.match(source, /className="mt-\[88px\] text-left w-\[600px\]/);
...
assert.match(source, /className=\{`mt-\[28px\] w-\[600px\]/);
assert.match(source, /mb-\[64px\]/);
assert.doesNotMatch(source, /mt-\[74px\]/);
assert.doesNotMatch(source, /mb-\[128px\]/);
